...
<c:forEach items="${customerMaster}" var="customer">
		...
		<div class="col-sm-1" align="center">
           ...
           <div align="right">
              Total Amount	${reqData.totalAmount }
              </div>  
...
<script>
  ...
  document.getElementById("divTitle").innerHTML="Sales Report 3";
  document.title +=" Sales Report 3 ";
...
{
	  window.location="?a=showSalesReport3&type=${type}&drpstoreId="
