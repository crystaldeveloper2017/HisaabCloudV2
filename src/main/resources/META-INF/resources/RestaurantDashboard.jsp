...
<div class="row">
          <div class="col-12 col-sm-6 col-md-3" onclick="window.location='?a=showGenerateInvoice'">
           ...
           <div class="col-12 col-sm-6 col-md-3" onclick="window.location='?a=showGeneratePurchaseInvoice'">
            <div class="info-box">
              <span class="info-box-icon bg-secondary elevation-1"><i class="fas fa-shopping-cart"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Generate Purchase Invoice</span>
          ...
          <div class="col-12 col-sm-6 col-md-3" onclick="window.location='?a=showBookingsRegister'">
            <div class="info-box mb-3">
          ...
          <div class="col-12 col-sm-6 col-md-3" onclick="window.location='?a=showGenerateQuote'">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-quote-right"></i></span>
              

              <div class="info-box-content">
                <span class="info-box-text">Generate Quotation</span>
          ...
          <div class="col-12 col-sm-6 col-md-3" onclick="window.location='?a=showVisitors'">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-success elevation-1"><i class="fas fa-solid fa-user""></i></span>
...
<script type="text/javascript">
        ...
        if('${param.fromDate}'!='')
        	...
        	document.getElementById("divTitle").innerHTML="<p1 class='labelFonts'>Hisaab Cloud (Restaurant)</p1>";
