...
document.getElementById("divTitle").innerHTML="ItemWise Sales Report";
document.title +=" ItemWise Sales Report ";
...
function exportCustomerItemHistory()
{
  ...
  {	  
  	  window.location="?a=showItemWiseReports&txtfromdate="+txtfromdate.value+"&txttodate="+txttodate.value;  	  
  }
