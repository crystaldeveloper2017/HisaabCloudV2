...
<c:set var="categoryCount" value='${requestScope["outputObject"].get("categoryDetails")}' />

<c:set var="itemCount" value='${requestScope["outputObject"].get("itemDetails")}' />
...
<script type="text/javascript">
        ...
        if('${param.fromDate}'!='')
        	...
        	document.getElementById("divTitle").innerHTML="<p1 class='labelFonts'>Hisaab Cloud (Jwellery)</p1>";
        	document.title +=" Jwellery";
        </script>
