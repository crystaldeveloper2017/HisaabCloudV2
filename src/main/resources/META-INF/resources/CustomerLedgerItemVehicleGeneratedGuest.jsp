...
<script >
 ...
 customerId.value='${param.customerId}';
  ...
  {	  
	  var encodedString=encodeURIComponent('${param.cipher}');
  	  window.location="?a=showLedgerForCustomerWithVehicle&txtfromdate="+txtfromdate.value+"&txttodate="+txttodate.value+"&cipher="+encodedString;  	  
  }
  ...
  function checkforMatchCustomer()
  {
  	...
  	if(customerId!=0)
  		{
  			document.getElementById("hdnSelectedCustomer").value="${param.cipher}";			
