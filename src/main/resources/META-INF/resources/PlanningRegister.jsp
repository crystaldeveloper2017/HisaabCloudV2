            ...
            <tbody>
                <c:forEach items="${lstPlanningRegister}" var="pendData">
                    <tr>
                        ...
                        <td>
                            <a href="?a=showGenerateInvoice&returnAction=showPlanningRegister&invoice_id=${pendData.invoice_id}&editInvoice=N&packaging_type=${pendData.packaging_type}">${pendData.city} (${pendData.totalQty}) </a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
