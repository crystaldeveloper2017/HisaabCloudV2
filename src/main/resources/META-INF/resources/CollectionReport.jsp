...
<c:set var="showPaymentCollectionReportFuel" value='${requestScope["outputObject"].get("testData")}' />
...
<script >
 ...
 customerId.value='${param.customerId}';
  ...
  {	 	  
  	  		window.location="?a=showPaymentCollectionReportFuel&txtfromdate="+txtfromdate.value+"&txttodate="+txttodate.value;
  ...
  document.getElementById("divTitle").innerHTML="Payment Collection Report";
  document.title +=" Payment Collection Report ";
