	...
	public CustomResultObject validateLogin(HttpServletRequest request, Connection con) {
		...
		try {
			...
			if (loginDetails != null && !loginDetails.isEmpty() ) {
				...
				boolean isAdmin=roleNames.contains("SuperAdmin") || roleNames.contains("Admin") || roleNames.contains("AdminServices") || roleNames.contains("AdminJwellery") ||roleNames.contains("AdminFuel")||roleNames.contains("AdminSnacks")||roleNames.contains("AdminElectric");
