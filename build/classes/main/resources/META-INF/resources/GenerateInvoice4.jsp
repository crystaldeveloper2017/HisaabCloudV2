...
function saveInvoice()
{
	...
	{   
	    ...
	    "~"+"0"+ // hard coded size
	    "~"+productDetailsId+
	    "~"+rows[x].childNodes[8].childNodes[0].childNodes[1].value+ // R SPH
	    "~"+rows[x].childNodes[8].childNodes[0].childNodes[3].value+ // R SPH
	    "~"+rows[x].childNodes[8].childNodes[0].childNodes[5].value+ // R SPH
	    "~"+rows[x].childNodes[8].childNodes[0].childNodes[7].value+ // R SPH
	    "~"+rows[x].childNodes[8].childNodes[0].childNodes[9].value+ // R SPH
	    "~"+rows[x].childNodes[8].childNodes[0].childNodes[11].value+ // R SPH
	    
	    "~"+rows[x].childNodes[8].childNodes[2].childNodes[1].value+ // L SPH
	    "~"+rows[x].childNodes[8].childNodes[2].childNodes[3].value+ // L SPH
	    "~"+rows[x].childNodes[8].childNodes[2].childNodes[5].value+ // L SPH
	    "~"+rows[x].childNodes[8].childNodes[2].childNodes[7].value+ // L SPH
	    "~"+rows[x].childNodes[8].childNodes[2].childNodes[9].value+ // L SPH
	    "~"+rows[x].childNodes[8].childNodes[2].childNodes[11].value+ // L SPH
	  ...
	  xhttp.onreadystatechange = function() {
	    if (this.readyState == 4 && this.status == 200) 
	    {
	    	...
	    	toastr.options = {"closeButton": false,"debug": false,"newestOnTop": false,"progressBar": false,
	      	...
	      	document.getElementById("divTitle").innerHTML="Generate Invoice Specs : "+(Number(invoiceId[0])+1);
	      	document.title +=" Generate Invoice Specs :  "+(Number(invoiceId[0])+1);
...
<div class="col-sm-1">
  ...
  <div class="col-sm-1">
  	<div class="form-group">      
      <input type="text" class="form-control form-control-sm" name="birthday" id="birthday" value="${customerDetails.Formattedbirthday}" name="birthday" placeholder="Birthday">
    </div>
  </div>
  ...
  <div class="col-sm-1">
  	<div class="form-group">      
      <input type="text" class="form-control form-control-sm" name="birthday" id="anniversary" value="${customerDetails.Formattedbirthday}" name="anniversary" placeholder="Anniversary">
    </div>
  </div>
  ...
  <div class="col-sm-1">
    ...
    <div class="col-sm-1">
  	<div class="form-group">            
  				<select id="customerGroup" name="customerGroup" class="form-control form-control-sm" >
   ...
   <div class="col-sm-1">
  	<div class="form-group">            
  				<select id="drpgender" name="drpgender" class="form-control form-control-sm" >
  ...
  <div class="col-sm-2">
  	<div class="form-group">
  		<input type="text" class="form-control form-control-sm"    placeholder="Address" id="txtitem" name="txtitem" >
    </div>
  </div>
  
  <div class="col-sm-1">
  	<div class="form-group">
  		<input type="text" class="form-control form-control-sm"    placeholder="City" id="txtcity" name="txtcity" >
    </div>
  </div>
  ...
  <div class="col-sm-2">
  	...
  	<div class="input-group input-group-sm">
                 <span class="input-group-append">
                    <button type="button" class="btn btn-primary btn-flat" onclick="quickAddCustomer()">Add New Customer</button>
                  </span>                         
    </div>
    </div>
  </div>
...
<div class="card card-primary" >
  ...
  <div class="col-sm-12">  
	  <div class="card-body table-responsive p-0" style="height: 370px;">                
	  			...
	  			<th style="z-index:0">SPH/CYL/AXIS/ADD/VA/IPD</th>
...
function getItemDetailsAndAddToTable(itemId,purchaseDetailsId)
{
		...
		var itemDetails=document.getElementById("hdn"+itemId).value.split("~");
		    ...
		    if(itemDetails[13]!='Frame' &&  itemDetails[13]!='Goggles')
		    	{
		    cell9.innerHTML = "<div class='input-group'>R   <input type='text' class='form-control form-control-sm' name='txtsgstamountgroup' id='txtsgstamount' value='1'   >      <input type='text' class='form-control form-control-sm' id='txtsgstpercent' value='2'> <input type='text' class='form-control form-control-sm' name='txtcgstamountgroup' id='txtcgstamount' value='3'   >      <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value='4'>  <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value='5'> <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value='6'> </div> <div class='input-group'> L  <input type='text' class='form-control form-control-sm' name='txtsgstamountgroup' id='txtsgstamount' value='1'   >      <input type='text' class='form-control form-control-sm' id='txtsgstpercent' value='2'> <input type='text' class='form-control form-control-sm' name='txtcgstamountgroup' id='txtcgstamount' value='3'   >      <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value='4'>  <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value='5'> <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value='6'> </div>";
		    cell10.innerHTML = "<input type='text' class='form-control form-control-sm' value='0' id='txtamount"+itemId+"' onkeyup='calculateQtyFromAmount("+itemId+")'>";
		    	}
		    else
		    	{
			    cell9.innerHTML = "<div class='input-group' style='display:none'>R   <input type='text' class='form-control form-control-sm' name='txtsgstamountgroup' id='txtsgstamount' value='0'   >      <input type='text' class='form-control form-control-sm' id='txtsgstpercent' value='0'> <input type='text' class='form-control form-control-sm' name='txtcgstamountgroup' id='txtcgstamount' value='0'   >      <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value='0'>  <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value='0'> <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value='0'> </div> <div class='input-group' style='display:none'> L  <input type='text' class='form-control form-control-sm' name='txtsgstamountgroup' id='txtsgstamount' value='0'   >      <input type='text' class='form-control form-control-sm' id='txtsgstpercent' value='0'> <input type='text' class='form-control form-control-sm' name='txtcgstamountgroup' id='txtcgstamount' value='0'   >      <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value='0'>  <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value='0'> <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value='0'> </div>";
			    cell10.innerHTML = "<input type='text' class='form-control form-control-sm' value='0' id='txtamount"+itemId+"' onkeyup='calculateQtyFromAmount("+itemId+")'>";
		    	}
		    
		    
		    
	    	cell11.innerHTML = '<button type="button" class="btn btn-sm btn-danger"  onclick=removethisitem(this) id="btn11" style="cursor:pointer">Delete</button>';
...
document.getElementById("divTitle").innerHTML="Generate Invoice Specs :- "+"${tentativeSerialNo}";
document.title +=" Generate Invoice Specs :- "+"${tentativeSerialNo} ";
...
if('${invoiceDetails.invoice_id}'!='')
	{
    	...
    	var R='${item.sph_r}'.split("~");
    	var L='${item.sph_l}'.split("~");
    	
    	cell9.innerHTML = "<div class='input-group'>R   <input type='text' class='form-control form-control-sm' name='txtsgstamountgroup' id='txtsgstamount' value="+R[0]+"   >      <input type='text' class='form-control form-control-sm' id='txtsgstpercent' value="+R[1]+"> <input type='text' class='form-control form-control-sm' name='txtcgstamountgroup' id='txtcgstamount' value="+R[2]+"   >      <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value="+R[3]+">  <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value="+R[4]+"> <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value="+R[5]+"> </div> <div class='input-group'> L  <input type='text' class='form-control form-control-sm' name='txtsgstamountgroup' id='txtsgstamount' value="+L[0]+"   >      <input type='text' class='form-control form-control-sm' id='txtsgstpercent' value="+L[1]+"> <input type='text' class='form-control form-control-sm' name='txtcgstamountgroup' id='txtcgstamount' value="+L[2]+"   >      <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value="+L[3]+">  <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value="+L[4]+"> <input type='text' class='form-control form-control-sm' onkeyup='' id='txtcgstpercent' value="+L[5]+"> </div>";
	    cell10.innerHTML = "<input type='text' class='form-control form-control-sm' value='0' id='txtamount' >";
    	
    	cell11.innerHTML = '<button type="button" class="btn btn-sm btn-danger"  onclick=removethisitem(this) id="btn11" name="deleteButtons" style="cursor:pointer">Delete</button> <button type="button" class="btn btn-primary"  onclick=returnThisItem("${item.details_id}") name="returnButtons" id="btn11" style="cursor:pointer">Return (${item.ReturnedQty})</button>';
...
function quickAddCustomer()
{
	...
	var xhttp = new XMLHttpRequest();
	  ...
	  xhttp.open("GET","?a=saveCustomerServiceAjax&appId=${userdetails.app_id}"+"&customerName="+customerName.value+"&mobileNumber="+mobileNumber.value+"&customerType="+customerType.value+"&drpgender="+drpgender.value+"&anniversary="+anniversary.value, true);    
	  xhttp.send();
}
