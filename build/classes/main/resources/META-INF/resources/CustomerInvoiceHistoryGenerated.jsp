              ...
              <div class="card-body table-responsive p-0" style="height: 480px;">                
                <table id="example1"class="table table-head-fixed  table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                    ...
                    <th><b>Invoice Date</b></th>
                     ...
                     <th><b>Discount</b>
                     <th><b>Bill Amount</b>  
					<th><b>AmountWithoutReturn</b>
					<th><b>ActualItemAmount</b>
               ...
               <div class="card-body table-responsive p-0">                
                <table id="testing"class="table table-head-fixed  table-bordered table-striped" role="grid" aria-describedby="example1_info">             
                 <thead>
                    ...
                    <th colspan="1"><b>Billed Amount (Invoice Amount Minus Returns): ${totalDetails.ItemAmountSum}</b></th>
                    <th colspan="1"><b>Item Amount (Invoice Amount) : ${totalDetails.sumActualItemAmount}</b></th>
...
<script >
  ...
  {	  
	  //alert(hdnSelectedCustomer.value);
  	  ...
  	  window.location="?a=showSalesRegister&txtfromdate="+txtfromdate.value+"&txttodate="+txttodate.value+"&customerId="+hdnSelectedCustomer.value;  	  
  }
